...
// Блокируем файл для исключения одновременного доступа
// LockFile(of, 0, 0, 0, 0);

// Конвертируем строку в ASCII для корректной работы с буфером
//wcstombs(cstr, str, strlen(cstr));

// Копируем новую строку в буфер после вставки
//for (int i = 0; i < strlen(cstr); i++)
//{
//    bufAfterIns[positionAfter++] = cstr[i];
//}
